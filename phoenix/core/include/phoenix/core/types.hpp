/**
 * @file types.hpp
 * @brief Core type definitions for Phoenix
 * 
...
/// Rational number (for frame rates, aspect ratios)
struct Rational {
    int num = 0;   // numerator
...
inline const char* errorCodeToString(ErrorCode code) {
    switch (code) {
        ...
        case ErrorCode::HWAccelNotAvailable: return "Hardware acceleration not available";
